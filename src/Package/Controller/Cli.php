...
class Cli extends Controller {
    ...
    const INFO = [
        ...
        '{{binary()}} r3m_io/basic configure ...      | apache2',
        '{{binary()}} r3m_io/basic configure ...      | apache2 backup',
        '{{binary()}} r3m_io/basic configure ...      | apache2 restore',
        '{{binary()}} r3m_io/basic configure ...      | apache2 restart',
        '{{binary()}} r3m_io/basic configure ...      | apache2 start',
        '{{binary()}} r3m_io/basic configure ...      | apache2 stop',
        '{{binary()}} r3m_io/basic configure ...      | php backup',
        '{{binary()}} r3m_io/basic configure ...      | php restore',
        '{{binary()}} r3m_io/basic configure ...      | php restart',
        '{{binary()}} r3m_io/basic configure ...      | php start ',
        '{{binary()}} r3m_io/basic configure ...      | php stop',
    ];
